<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="task_gen.php">
        <span class="menu-title">Task Generation</span>
        <i class="mdi mdi-format-list-bulleted menu-icon"></i>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="task_mgmt.php">
    ...
    <li class="nav-item">
      <a class="nav-link" href="section.php">
        <span class="menu-title">Section Reporting</span>
